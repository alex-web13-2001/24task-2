...
import { Calendar, Flame, Tag, Plus, MoreHorizontal, X, Check, Trash2 } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const initialColumns: Column[] = [
  {
    ...
    tasks: [
      ...
      {
        id: '5',
        title: 'Исправить критический баг в оплате',
        priority: 'urgent',
        category: 'Баги',
        categoryId: 'bugs',
        ...
        assigneeId: 'dk',
        dueDate: '1 ноя',
        dueDateRaw: new Date('2024-11-01'),
        tags: ['bug', 'critical'],
        status: 'assigned',
      },
    ],
    ...
    tasks: [
      {
        ...
        assigneeId: 'es',
        dueDate: '2 ноя',
        dueDateRaw: new Date('2024-11-02'),
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem>Добавить колонку справа</DropdownMenuItem>
                    {column.canDelete && (
                      <DropdownMenuItem
                    ...
                    >
                      ...
                      <CardContent className="pb-3 space-y-3">
                        <div className="flex items-center gap-2 flex-wrap">
                          <Badge
                            variant="outline"
                            className={`${task.categoryColor} text-white border-0`}
                          >
